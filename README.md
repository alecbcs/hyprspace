...
# Local Hyprspace Network

### This is a fork from the original Hyprspace project which aims to provide the ability to create a network locally between nodes on restricted networks
...
- [Original Hyprspace Documentation](#hyprspace)
